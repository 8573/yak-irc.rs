...
quickcheck! {
    fn event_context_id_mio_token_conversion_bijective_1(n1: usize, n2: usize) -> TestResult {
        let client = ThinClient::<NullMsg>::new();
        ...
        let evt_ctx_id_1 = client.mk_event_ctx_id_from_mio_token(mio_tok_1);
        let evt_ctx_id_2 = client.mk_event_ctx_id_from_mio_token(mio_tok_2);
    ...
    fn event_context_id_mio_token_conversion_roundtrip_1(token_number: usize) -> TestResult {
        ...
        let evt_ctx_id = client.mk_event_ctx_id_from_mio_token(mio_tok_1);
